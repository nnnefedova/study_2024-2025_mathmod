...
subtitle: "Модель конкуренции двух фирм. Вариант №58"
...
![График конкуренции двух фирм фирм для первого случая, построенный на языке Julia](image/lab8_julia_1.PNG){ #fig:001 width=70% height=50% }

![График конкуренции двух фирм для второго случая, построенный на языке Julia](image/lab8_julia_2.PNG){ #fig:002 width=70% height=50% }
...
![График конкуренции двух фирм для первого случая, построенный с помощью OpenModelica](image/lab8_openmodelica_1.PNG){ #fig:004 width=70% height=50% }

![График конкуренции двух фирм для второго случая, построенный с помощью OpenModelica](image/lab8_openmodelica_2.PNG){ #fig:005 width=70% height=50% }
